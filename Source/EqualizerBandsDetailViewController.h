...
#ifndef EQUALIZERBANDSDETAILVIEWCONTROLLER_H
#define EQUALIZERBANDSDETAILVIEWCONTROLLER_H
...
@interface EqualizerBandsDetailViewController : UITableViewController <ApplicationControllerDelegate>
{
    /**
...
#endif // EQUALIZERBANDSDETAILVIEWCONTROLLER_H
